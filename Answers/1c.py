...
min_bic = allCombResult.loc[allCombResult['Bayesian Information Criterion'].idxmin()]
print("Lowest BIC value on the Training partition",min_bic['Bayesian Information Criterion'])
print("model producing the Lowest BIC value on the Training partition",min_bic['Model Term'])
